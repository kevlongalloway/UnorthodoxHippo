...
import { LENSES, getTier, fmtN } from '../themes.js';
        ...
        <div style={{
          ...
          <input
            ...
            style={{
              ...
              fontFamily: T.ui, fontSize: 14, color: T.text,
            }}
          />
          {search && (
            <button onClick={() => setSearch('')} style={{ background: 'none', border: 'none', color: T.text4, cursor: 'pointer', fontSize: 16 }}>×</button>
          )}
        </div>
      </div>
        ...
        {EXPLORE_TABS.map(t => (
          <button
            ...
            style={{
              ...
              color: tab === t ? (T.id === 'twilight' ? T.bg : '#fff') : T.text3,
    ...
    <div style={{
      ...
      {rank !== undefined && (
        <div style={{
          ...
          background: T.bg3,
          fontFamily: T.ui, fontSize: 11, fontWeight: 700, color: T.text4,
        }}>
          {rank}
        </div>
      )}
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 4 }}>
          <span style={{ fontSize: 11, fontFamily: T.ui, color: T.gold }}>★ {book.rating}</span>
          <span style={{ fontSize: 10, color: T.text4 }}>·</span>
          <span style={{ fontSize: 11, fontFamily: T.ui, color: T.text4 }}>{book.reviews} reviews</span>
          <span style={{
            marginLeft: 4, fontSize: 10, fontFamily: T.ui, fontWeight: 600,
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontFamily: T.ui, fontSize: 12, color: T.text4, marginBottom: 4 }}>
          {reader.handle}
        </div>
        ...
        {reader.currentlyReading && (
          <div style={{ fontSize: 11, fontFamily: T.ui, color: T.text4, marginTop: 4, fontStyle: 'italic' }}>
...
function TagsView({ T }) {
  const tags = [
    ...
    { label: 'Grief', count: 389, color: T.text3 },
    ...
    { label: 'Quiet', count: 142, color: T.text3 },
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
        {tags.map(tag => (
          <button key={tag.label} style={{
            ...
            <span style={{ fontFamily: T.ui, fontSize: 13, fontWeight: 600, color: tag.color }}>
              {tag.label}
            </span>
            <span style={{ fontFamily: T.ui, fontSize: 11, color: T.text4, marginLeft: 6 }}>
              {fmtN(tag.count)}
            </span>
          </button>
        ))}
